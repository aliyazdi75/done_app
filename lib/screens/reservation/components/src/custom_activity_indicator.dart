...
class CustomCupertinoActivityIndicator extends StatefulWidget {
  ...
  @override
  State<CustomCupertinoActivityIndicator> createState() =>
...
class _CustomCupertinoActivityIndicatorState
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: CustomPaint(
        painter: _CustomCupertinoActivityIndicatorPainter(
...
class _CustomCupertinoActivityIndicatorPainter extends CustomPainter {
  _CustomCupertinoActivityIndicatorPainter({
  ...
  @override
  bool shouldRepaint(_CustomCupertinoActivityIndicatorPainter oldPainter) {
